...
const options = {
  method: "GET",
  headers: {
    "X-RapidAPI-Key": "50a1055ce9msh3e4c161c1e868a1p12e824jsn4becf68ba32c", // I'm exponsing this api key intentionally :D
    "X-RapidAPI-Host": "weatherapi-com.p.rapidapi.com",
  },
};

fetch(
  "https://weatherapi-com.p.rapidapi.com/current.json?q=iata%3AEZE",
  options
)
...
texto_marquesina.innerText =
  "Bienvenid@ a JetCompra, hoy es " +
  dt.setLocale("es").toLocaleString(DateTime.DATE_FULL) +
  ".";
